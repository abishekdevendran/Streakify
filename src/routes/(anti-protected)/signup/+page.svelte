		...
		<Card.Content>
			<form class="grid gap-4">
				<div class="grid gap-2">
					...
					<Input autocomplete="name" id="name" bind:value={name} type="text" placeholder="Gon Freece" required />
				</div>
				<div class="grid gap-2">
					<Label for="email">Email</Label>
					<Input autocomplete="email" id="email" bind:value={email} type="email" placeholder="m@example.com" required />
				</div>
				<div class="grid gap-2">
					...
					<div class="relative w-full">
						<Input id="password" bind:value={password} type={passwordVisible ? 'text' : 'password'} required autocomplete="new-password" />
						{#if passwordVisible}
							<Eye
